...
class FlowEngine:
    ...
    def _setup_logging(self):
        ...
        setup_logging(
            log_file=Path(self.config.project_dir) / self.config.log_dir / self.config.log_file,
    ...
    def load_procedure(self, sketch_file: str) -> bool:
        ...
        try:
            ...
            self.current_procedure = Procedure(procedure_data, self.config)
